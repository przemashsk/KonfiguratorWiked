<template>
  <v-group :config="{ x: left, y: top }">
    <v-image
      id="okleina"
      :config="{ width: width, height: height, image: okleinaimage }"
    ></v-image>
    <v-image
      id="mixokleina"
      v-if="mixbool"
      :config="{
        ...
        x: mixcCorrectX - 6,
        image: okleinaimage2,
        crop: { width: mixc.cropwidth, height: height },
      }"
    ></v-image>
    -->
    ...
    <v-image
      id="szyba"
      :config="{ width: width, height: height, image: szybaimage }"
    ></v-image>
    <v-image
      id="tloczenie"
      :config="{ width: width, height: height, image: tloczenieimage }"
    ></v-image>
    <v-image
      v-if="
      ...
      "
      id="tloczeniee"
      :config="{ width: width, height: height, image: tloczenieimagee }"
    ></v-image>
    <v-image
      id="klamka"
      :config="{ width: width, height: height, image: klamkaimage }"
      turnable="false"
    ></v-image>
    <v-rect
      :config="{
...
export default {
  ...
  methods: {
    ...
    drawSzyba() {
      ...
      const imageObj = new Image();
      imageObj.src =
        "/images/szyby/" + this.odpszyb + "_" + this.szybac + ".png";
      imageObj.onload = () => {
