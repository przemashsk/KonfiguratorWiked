<template>
  <div id="app">
    <!-- <div id="rotate">
      <img src="/images/mobile-portrait-to-landscape.svg" alt="" />
    </div> -->
    <!-- <tabs class="sticky-top"> -->
    <div>
      <tabs style="background: #292929;z-index: 1;"></tabs>
      <!-- <tabs style="    background: url(https://wallpapercave.com/wp/DCQewPZ.png); -->
      <!-- z-index: 1;
    ...
    <div v-if="activeTab == 'inspiracja'" class="protect">
      <div style="display:flex;flex-direction:column;gap:51px">
        ...
        >
          ...
          <img v-if="product.protect == 'dom'" src="/images/konfigurator/step2/drzwi.png" />
          <img v-else src="/images/konfigurator/step2/zaprojektuj drzwi Protect.png" />
        </div>
        ...
        >
          ...
          <img v-if="product.protect == 'dom'" src="/images/konfigurator/step2/inpiracje.png" />
          <img v-else src="/images/konfigurator/step2/przejrzyj inspiracje protect.png" />
        </div>
      </div>
    </div>

    <div class="d-flex" style="flex-direction: column;" v-show="activeTab != 'inspiracja' && activeTab != 'protect'" :class="activeTab == 'inspiracja' || activeTab == 'protect' ? 'ups' : ''">
      <!-- <tabs style="background: #292929;z-index: 1;"></tabs> -->
      <div class="d-flex lewy" :class="activeTab == 'inspiracja' || activeTab == 'protect' ? 'ups' : ''">
        <div class="d-flex flex-1" v-if="activeTab != 'Podsumowanie'">
          ...
          <filtry id="filtry" v-if="(activeTab == 'Model' && product.protect == 'dom') || product.inspiracja == 'tak'" onclick="$(this).attr('title','')"></filtry>
          <div class="filtryinspiracje" v-if="product.inspiracja == 'tak' && product.protect == 'dom' && activeTab == 'Inspiracje'">
            <!-- <div class="filtryinspiracjeitem">Wszystkie</div> -->
            <div
              @click="
                handle('Inspiracje');
          ...
          <!-- <div class="wizualizacje">
            <div>
              <img src="images\konfigurator\konf ins\dodatkowe Inspirację ADAM\Dla tradycjonalisty\50.jpg" alt="">
            </div>
            <div>
              <img src="images\konfigurator\konf ins\dodatkowe Inspirację ADAM\Dla tradycjonalisty\FI14.jpg" alt="">
            </div>
          </div> -->
        ...
        <div :class="activeTab == 'Podsumowanie' ? '' : 'ukryj'" class="podsumowanie" v-show="product.inspiracja == 'nie' || (product.inspiracja == 'tak' && product.inspiracjanr != '')" :style="activeTab != 'Podsumowanie' ? 'min-width: 555px;' : ''">
          <div :class="activeTab == 'Podsumowanie' ? 'last' : 'podsumowanie2'">
            <!-- <div class="bottom" v-if="product.inspiracja == 'tak' && activeTab == 'Podsumowanie'"> -->
              <!-- <img src="images\konfigurator\buttons\zmien.png" class="klaudia" @click="handle('Inspiracje')" /> -->
            ...
            <!-- <img src="images/konfigurator/konf ins/1(2).jpg" alt="" @click="product.inspiracjanr = '1'" style="max-height: 520px;margin-top: auto;" /> -->
            <!-- <podsumowanie></podsumowanie> -->
            <div style="display:flex;flex-direction:column;gap:15px">
              <!-- <navbuttons></navbuttons> -->
              <switcher id="sw" style="gap: 20px;display: flex;justify-content: center;" class="ab"></switcher>
              <wizualizacja style="margin: 0 auto;" class="fitCenter nomobile"></wizualizacja>
            </div>
            <!-- <div class="mobile">
